...
GO
CREATE NONCLUSTERED INDEX [IX_dimcustomer_addressfourstatus] ON [dbo].[DimCustomer] ([AddressFourIsCleanStatus]) INCLUDE ([AddressFourStreet], [DimCustomerId]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_AddressFour] ON [dbo].[DimCustomer] ([AddressFourIsCleanStatus], [IsDeleted]) INCLUDE ([AddressFourCity], [AddressFourCountry], [AddressFourCounty], [AddressFourState], [AddressFourStreet], [AddressFourSuite], [AddressFourZip], [CustomerType], [DimCustomerId], [SourceSystem]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_dimcustomer_addressOnestatus] ON [dbo].[DimCustomer] ([AddressOneIsCleanStatus]) INCLUDE ([AddressOneStreet], [DimCustomerId]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_AddressOne] ON [dbo].[DimCustomer] ([AddressOneIsCleanStatus], [IsDeleted]) INCLUDE ([AddressOneCity], [AddressOneCountry], [AddressOneCounty], [AddressOneState], [AddressOneStreet], [AddressOneSuite], [AddressOneZip], [CustomerType], [DimCustomerId], [SourceSystem]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_dimcustomer_addressprimarystatus] ON [dbo].[DimCustomer] ([AddressPrimaryIsCleanStatus]) INCLUDE ([AddressPrimaryStreet], [DimCustomerId]) WITH (DATA_COMPRESSION = PAGE)
GO
...
GO
CREATE NONCLUSTERED INDEX [IX_dimcustomer_addressthreestatus] ON [dbo].[DimCustomer] ([AddressThreeIsCleanStatus]) INCLUDE ([AddressThreeStreet], [DimCustomerId]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_AddressThree] ON [dbo].[DimCustomer] ([AddressThreeIsCleanStatus], [IsDeleted]) INCLUDE ([AddressThreeCity], [AddressThreeCountry], [AddressThreeCounty], [AddressThreeState], [AddressThreeStreet], [AddressThreeSuite], [AddressThreeZip], [CustomerType], [DimCustomerId], [SourceSystem]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_dimcustomer_addresstwostatus] ON [dbo].[DimCustomer] ([AddressTwoIsCleanStatus]) INCLUDE ([AddressTwoStreet], [DimCustomerId]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_AddressTwo] ON [dbo].[DimCustomer] ([AddressTwoIsCleanStatus], [IsDeleted]) INCLUDE ([AddressTwoCity], [AddressTwoCountry], [AddressTwoCounty], [AddressTwoState], [AddressTwoStreet], [AddressTwoSuite], [AddressTwoZip], [CustomerType], [DimCustomerId], [SourceSystem]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_dimcustomer_emailonestatus] ON [dbo].[DimCustomer] ([EmailOneIsCleanStatus]) INCLUDE ([DimCustomerId], [EmailOne]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_EmailOne] ON [dbo].[DimCustomer] ([EmailOneIsCleanStatus], [IsDeleted]) INCLUDE ([CustomerType], [DimCustomerId], [EmailOne], [SourceSystem]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_dimcustomer_emailprimarystatus] ON [dbo].[DimCustomer] ([EmailPrimaryIsCleanStatus]) INCLUDE ([DimCustomerId], [EmailPrimary]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_EmailPrimary] ON [dbo].[DimCustomer] ([EmailPrimaryIsCleanStatus], [IsDeleted]) INCLUDE ([CustomerType], [DimCustomerId], [EmailPrimary], [SourceSystem]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_dimcustomer_emailtwostatus] ON [dbo].[DimCustomer] ([EmailTwoIsCleanStatus]) INCLUDE ([DimCustomerId], [EmailTwo]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_EmailTwo] ON [dbo].[DimCustomer] ([EmailTwoIsCleanStatus], [IsDeleted]) INCLUDE ([CustomerType], [DimCustomerId], [EmailTwo], [SourceSystem]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_dimcustomer_customer_matchkey] ON [dbo].[DimCustomer] ([FirstName], [LastName], [customer_matchkey]) INCLUDE ([DimCustomerId], [SourceSystem], [SourceSystemPriority], [SSCreatedDate], [SSID], [SSUpdatedDate]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_CompanyName] ON [dbo].[DimCustomer] ([IsDeleted]) INCLUDE ([CompanyName], [CustomerType], [DimCustomerId], [SourceSystem]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_dimcustomer_isdeleted] ON [dbo].[DimCustomer] ([IsDeleted]) INCLUDE ([DimCustomerId], [SourceSystem], [SSID]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_dimcustomer_IsBusiness] ON [dbo].[DimCustomer] ([IsDeleted], [IsBusiness]) INCLUDE ([DimCustomerId]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_NameIsCleanStatus] ON [dbo].[DimCustomer] ([NameIsCleanStatus], [IsDeleted]) INCLUDE ([DimCustomerId]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_dimcustomer_phonebusinessstatus] ON [dbo].[DimCustomer] ([PhoneBusinessIsCleanStatus]) INCLUDE ([DimCustomerId], [PhoneBusiness]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_PhoneBusiness] ON [dbo].[DimCustomer] ([PhoneBusinessIsCleanStatus], [IsDeleted]) INCLUDE ([CustomerType], [DimCustomerId], [PhoneBusiness], [SourceSystem]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_dimcustomer_phonecellstatus] ON [dbo].[DimCustomer] ([PhoneCellIsCleanStatus]) INCLUDE ([DimCustomerId], [PhoneCell]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_PhoneCell] ON [dbo].[DimCustomer] ([PhoneCellIsCleanStatus], [IsDeleted]) INCLUDE ([CustomerType], [DimCustomerId], [PhoneCell], [SourceSystem]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_dimcustomer_phonefaxstatus] ON [dbo].[DimCustomer] ([PhoneFaxIsCleanStatus]) INCLUDE ([DimCustomerId], [PhoneFax]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_PhoneFax] ON [dbo].[DimCustomer] ([PhoneFaxIsCleanStatus], [IsDeleted]) INCLUDE ([CustomerType], [DimCustomerId], [PhoneFax], [SourceSystem]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_dimcustomer_phonehomestatus] ON [dbo].[DimCustomer] ([PhoneHomeIsCleanStatus]) INCLUDE ([DimCustomerId], [PhoneHome]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_PhoneHome] ON [dbo].[DimCustomer] ([PhoneHomeIsCleanStatus], [IsDeleted]) INCLUDE ([CustomerType], [DimCustomerId], [PhoneHome], [SourceSystem]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_dimcustomer_phoneotherstatus] ON [dbo].[DimCustomer] ([PhoneOtherIsCleanStatus]) INCLUDE ([DimCustomerId], [PhoneOther]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_PhoneOther] ON [dbo].[DimCustomer] ([PhoneOtherIsCleanStatus], [IsDeleted]) INCLUDE ([CustomerType], [DimCustomerId], [PhoneOther], [SourceSystem]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_dimcustomer_phoneprimarystatus] ON [dbo].[DimCustomer] ([PhonePrimaryIsCleanStatus]) INCLUDE ([DimCustomerId], [PhonePrimary]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_PhonePrimary] ON [dbo].[DimCustomer] ([PhonePrimaryIsCleanStatus], [IsDeleted]) INCLUDE ([CustomerType], [DimCustomerId], [PhonePrimary], [SourceSystem]) WITH (DATA_COMPRESSION = PAGE)
GO
