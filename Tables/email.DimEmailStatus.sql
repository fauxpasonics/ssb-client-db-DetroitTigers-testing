...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailS__Creat__5C02A283] DEFAULT (getdate()),
[CreatedBy] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[UpdatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailS__Updat__5CF6C6BC] DEFAULT (getdate()),
